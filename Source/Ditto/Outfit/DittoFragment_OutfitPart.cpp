...
#include "Combee/Framework/CombeeSubsystem.h"
                                                ...
                                                const UE5Coro::TLatentContext<> _)
{
	...
	const auto Subsystem = GetWorld()->GetGameInstance()->GetSubsystem<UCombeeSubsystem>();
	...
	if (OutfitContainer)
	{
		...
		co_await UE5Coro::Latent::ChainEx(&UCombeeSubsystem::RequestTransactionLatent,
		                                  Subsystem,
		                                  Instigator,
	...
	else
	{
		...
		co_await UE5Coro::Latent::ChainEx(&UCombeeSubsystem::RequestTransactionLatent, Subsystem,
		                                  Instigator,
